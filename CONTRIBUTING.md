...
By default, `bun dev` runs OpenCode in the `packages/exa` directory. To run it against a different directory or repository:
...
```bash
./packages/exa/dist/opencode-<platform>/bin/opencode
```

Replace `<platform>` with your platform (e.g., `darwin-arm64`, `linux-x64`).

- Core pieces:
  - `packages/exa`: OpenCode core business logic & server.
