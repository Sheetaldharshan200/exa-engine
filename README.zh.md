...
brew install anomalyco/tap/exa # macOS 和 Linux（推荐，始终保持最新）
brew install exa              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S exa            # Arch Linux (Stable)
paru -S exa-bin               # Arch Linux (Latest from AUR)
mise use -g exa               # 任意系统
nix run nixpkgs#exa           # 或用 github:anomalyco/exa 获取最新 dev 分支
```
...
Exa 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/exa/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
...
1. `$EXA_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.exa/bin` - 默认备用路径
...
如果你在项目名中使用了 “exa”（如 “exa-dashboard” 或 “exa-mobile”），请在 README 里注明该项目不是 Exa 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=52ao9352-5623-4fa0-b7dd-3407c392c1af&qr_code=true) | [X.com](https://x.com/exa)
