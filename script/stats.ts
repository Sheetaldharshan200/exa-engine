...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Sheetaldharshan200/exa-engine/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Sheetaldharshan200/exa-engine...\n")
...
console.log("Fetching npm all-time downloads for exa-ai...\n")
const npmDownloads = await fetchNpmDownloads("exa-ai")
