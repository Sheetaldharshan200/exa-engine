...
import { compile, emitEffectImported, emitPromise, write } from "@exa/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "ExaEventEncoded",
              import: 'import type { ExaEventEncoded } from "@exa/protocol/groups/event"',
            },
          },
        }),
