...
import compareVideo from "../../asset/lander/exa-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/exa-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="exa:auth" content={loggedin() ? "true" : "false"} />
