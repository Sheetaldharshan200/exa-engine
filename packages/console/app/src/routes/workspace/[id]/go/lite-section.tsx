...
import { Database, eq, and, isNull } from "@exa/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@exa/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#exa-go")} target="_blank" rel="noopener noreferrer">
