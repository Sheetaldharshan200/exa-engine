...
Schema-first LLM core for exa. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@exa/llm"
import { OpenAI } from "@exa/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@exa/llm/providers"
