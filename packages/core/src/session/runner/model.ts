...
import { type Model } from "@exa/llm"
import * as AnthropicMessages from "@exa/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@exa/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@exa/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@exa/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@exa/v2/SessionRunnerModel") {}
