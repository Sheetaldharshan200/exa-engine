...
import { Entry, FileSystem, FindInput, Match } from "@exa/schema/filesystem"
export { Entry, Match, Submatch } from "@exa/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@exa/v2/FileSystem") {}
