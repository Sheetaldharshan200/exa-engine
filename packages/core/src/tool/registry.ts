...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@exa/llm"
...
export class Service extends Context.Service<Service, Interface>()("@exa/v2/ToolRegistry") {}
