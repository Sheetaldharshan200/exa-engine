...
import { Event } from "@exa/schema/project-directories"
import { ProjectCopy } from "@exa/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@exa/ProjectCopy") {}
