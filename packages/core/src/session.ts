...
import { ListAnchor } from "@exa/schema/session"
...
import { SessionDurable } from "@exa/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@exa/v2/Session") {}
