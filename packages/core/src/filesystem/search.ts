...
export class Service extends Context.Service<Service, Interface>()("@exa/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.EXA_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
