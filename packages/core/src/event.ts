...
import type { Data, Definition, Payload } from "@exa/schema/event"
...
import { Durable } from "@exa/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@exa/schema/event").ID
export type { Data, Definition, Payload } from "@exa/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@exa/Event") {}
