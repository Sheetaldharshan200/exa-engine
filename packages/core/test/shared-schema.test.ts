...
import { Agent } from "@exa/schema/agent"
import { Location } from "@exa/schema/location"
import { Model } from "@exa/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@exa/schema/prompt"
import { Provider } from "@exa/schema/provider"
import { Project } from "@exa/schema/project"
import { ProjectDirectories } from "@exa/schema/project-directories"
import { PermissionV1 } from "@exa/schema/permission-v1"
import { Session } from "@exa/schema/session"
import { SessionInput } from "@exa/schema/session-input"
import { SessionMessage } from "@exa/schema/session-message"
import { Workspace } from "@exa/schema/workspace"
import { Command } from "@exa/schema/command"
import { Connection } from "@exa/schema/connection"
import { Credential } from "@exa/schema/credential"
import { FileSystem } from "@exa/schema/filesystem"
import { Integration } from "@exa/schema/integration"
import { LLM } from "@exa/schema/llm"
import { Permission } from "@exa/schema/permission"
import { Plugin } from "@exa/schema/plugin"
import { Pty } from "@exa/schema/pty"
import { Reference } from "@exa/schema/reference"
import { SessionTodo } from "@exa/schema/session-todo"
import { Skill } from "@exa/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@exa/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@exa/core/command"),
    import("@exa/core/integration/connection"),
    import("@exa/core/credential"),
    import("@exa/core/filesystem"),
    import("@exa/core/integration"),
    import("@exa/core/location"),
    import("@exa/llm"),
    import("@exa/core/permission"),
    import("@exa/core/v1/permission"),
    import("@exa/core/project/copy"),
    import("@exa/core/pty"),
    import("@exa/core/project/schema"),
    import("@exa/core/reference"),
    import("@exa/core/session/input"),
    import("@exa/core/session/message"),
    import("@exa/core/session/todo"),
    import("@exa/core/session/prompt"),
    import("@exa/core/skill"),
    import("@exa/core/v2-schema"),
    import("@exa/core/schema"),
    import("@exa/core/workspace"),
  ])
