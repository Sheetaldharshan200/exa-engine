...
class Database extends Context.Service<Database, DatabaseShape>()("@exa/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@exa/example/UserStore") {
