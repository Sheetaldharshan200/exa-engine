...
import { createOpencodeClient } from "@exa/sdk/v2/client"
import { ServerAuth } from "@exa/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@exa/cli/Daemon") {}
