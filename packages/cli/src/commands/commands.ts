...
declare const EXA_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof EXA_CLI_NAME === "string" ? EXA_CLI_NAME : "exa", {
  description: "Exa 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
