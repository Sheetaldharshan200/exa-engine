...
const releaseId = process.env.EXA_RELEASE
if (!releaseId) throw new Error("EXA_RELEASE is required")

const version = process.env.EXA_VERSION
if (!version) throw new Error("EXA_VERSION is required")
...
const macxTarGz = "exa-desktop-mac-x64.app.tar.gz"
const macaTarGz = "exa-desktop-mac-arm64.app.tar.gz"
