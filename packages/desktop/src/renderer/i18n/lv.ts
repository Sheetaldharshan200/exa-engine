export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Exa versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Exa versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
  ...
  "desktop.cli.installed.message":
    "CLI instalēts uz {{path}}\n\nRestartējiet termināli, lai izmantotu komandu 'exa'.",
