export const dict = {
  ...
  "desktop.updater.none.message": "Exa-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Exa-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'exa' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
