export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Exan uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Exan versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Exan uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'exa'-komentoa.",
