export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Exa",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Exa is gedownload. Wil je deze installeren en Exa opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'exa' te gebruiken.",
