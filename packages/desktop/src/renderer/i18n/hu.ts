export const dict = {
  ...
  "desktop.updater.none.message": "Már az Exa legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Exa {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsa újra a terminált az 'exa' parancs használatához.",
