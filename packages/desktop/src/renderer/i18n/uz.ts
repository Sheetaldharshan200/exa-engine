export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Exa ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Exaning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'exa' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
