export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Exa uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Exa'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „exa” kasutamiseks taaskäivitage terminal.",
