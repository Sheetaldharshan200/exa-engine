export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Exa",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Exa. ¿Quieres instalarla y reiniciar?",
