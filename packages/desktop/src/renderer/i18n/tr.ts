export const dict = {
  ...
  "desktop.updater.none.message": "Exa'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Exa'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'exa' komutunu kullanmak için terminalinizi yeniden başlatın.",
