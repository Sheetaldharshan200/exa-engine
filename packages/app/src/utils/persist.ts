...
const GLOBAL_STORAGE = "exa.global.dat"
const WINDOW_STORAGE = "exa.window"
const LOCAL_PREFIX = "exa."
...
function workspaceStorage(dir: string) {
  ...
  return `exa.workspace.${head}.${sum}.dat`
}
