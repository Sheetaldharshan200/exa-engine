...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "exa", key: "dialog.provider.exa.note" },
  { match: (id: string) => id === "exa-go", key: "dialog.provider.exaGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "exa" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "exa" || item.id === "exa-go"}>
