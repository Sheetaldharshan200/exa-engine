...
beforeAll(async () => {
  ...
  mock.module("@exa/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@exa/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@exa/ui/icon", () => ({ Icon: () => null }))
  mock.module("@exa/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
