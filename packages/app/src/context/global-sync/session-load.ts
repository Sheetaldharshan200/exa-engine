import type { SessionApi } from "@exa-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { ExaClient } from "@exa/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: ExaClient; directory: string; limit: number }) {
  try {
