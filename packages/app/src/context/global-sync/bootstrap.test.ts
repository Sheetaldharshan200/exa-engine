...
import type { Config, ExaClient, Project } from "@exa/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@exa-ai/client/promise"
import type { NormalizedProviderListResponse } from "@exa/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
