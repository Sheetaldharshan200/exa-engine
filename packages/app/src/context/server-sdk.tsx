import type { ExaEvent } from "@exa-ai/client/promise"
import type { Event } from "@exa/sdk/v2/client"
...
export type ServerEvent = Event & { current?: ExaEvent }
...
export function adaptServerEvent(event: ExaEvent): ServerEvent {
...
function currentDelta(event: ExaEvent | undefined): CurrentDelta | undefined {
  if (
