...
import { NormalizedProviderListResponse } from "@exa/session-ui/context"
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ExaClient) =>
  queryOptions({
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, ExaClient>()
