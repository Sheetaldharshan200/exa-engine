import type { ExaEvent, SessionMessageInfo, SessionPendingMessage } from "@exa-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: ExaEvent): V2SessionReduction | undefined => {
