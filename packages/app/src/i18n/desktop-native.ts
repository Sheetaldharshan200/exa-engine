...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Exa failed to load",
  "desktop.recovery.terminated": "Exa window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Exa is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Exa installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.exaMissing": "exa is not installed in this distro",
  "desktop.wsl.error.exaCannotRun": "exa is installed but could not run",
  "desktop.wsl.error.exaNotInstalled": "Exa is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
