export const dict = {
  ...
  "desktop.recovery.loadFailed": "Exa kunde inte läsas in",
  "desktop.recovery.terminated": "Exa-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Exa svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Exa misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.exaMissing": "exa är inte installerat i den här distributionen",
  "desktop.wsl.error.exaCannotRun": "exa är installerat men kunde inte köras",
  "desktop.wsl.error.exaNotInstalled": "Exa är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.exa.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.exa.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.exaGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Exa",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Exa.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i exa.json",
  ...
  "dialog.server.description": "Växla vilken Exa-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Exa i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Exa i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Exa i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Exa",
  "wsl.onboarding.exaReadyIn": "Exa är redo i {{distro}}.",
  "wsl.onboarding.exaReady": "Exa är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Exa i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Exa kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Exa kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Exa igen.",
  ...
  "help.tabs.introduction": "Exa Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Exa ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Exa-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (exa.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Exa stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Exa innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Exa-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Exa",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Exa ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Exa följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Exas tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Exa startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Exa.",
