export const dict = {
  ...
  "dialog.provider.exa.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.exa.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.exaGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Exan tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Exassa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Exassa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Exassa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään exa.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Exa-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Exaa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Exaa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Exaa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Exaa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Exa jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Exa",
  "wsl.onboarding.exaReadyIn": "Exa on valmis jakelussa {{distro}}.",
  "wsl.onboarding.exaReady": "Exa on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Exa jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exaa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Exa voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Exa ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Exa uudelleen.",
  ...
  "toast.update.description": "Exan uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Exa-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (exa.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Exa ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Exa sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Exa-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Exan näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Exa näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Exa järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Exan teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Exa käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Exan uusinta versiota.",
  ...
  "desktop.menu.documentation": "Exa-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Exa-valikko",
  ...
  "desktop.recovery.loadFailed": "Exan lataaminen epäonnistui",
  "desktop.recovery.terminated": "Exa-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Exa ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Exan asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.exaMissing": "exaa ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.exaCannotRun": "exa on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.exaNotInstalled": "Exaa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exan päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Exa Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
