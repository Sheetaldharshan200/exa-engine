export const dict = {
  ...
  "dialog.provider.exa.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.exa.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.exaGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Exa",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.exaZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.exaZen.visit.prefix": "Besøg ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Exa.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i exa.json",
  ...
  "dialog.server.description": "Skift hvilken Exa-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Exa i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Exa i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Exa i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Exa kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Exa kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Exa igen.",
  ...
  "toast.update.description": "En ny version af Exa ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Exa-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (exa.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Exa understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Exa inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Exa-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Exa",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Exa ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Exa skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Exas tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Exa starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Exa.",
  ...
  "desktop.recovery.loadFailed": "Exa kunne ikke indlæses",
  "desktop.recovery.terminated": "Exa-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Exa mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.exaMissing": "exa er ikke installeret i denne distribution",
  "desktop.wsl.error.exaCannotRun": "exa er installeret, men kunne ikke køre",
  "desktop.wsl.error.exaNotInstalled": "Exa er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Exa er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Exa Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
