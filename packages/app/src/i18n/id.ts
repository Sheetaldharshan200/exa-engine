export const dict = {
  ...
  "desktop.recovery.loadFailed": "Exa gagal dimuat",
  "desktop.recovery.terminated": "Jendela Exa berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Exa tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Exa gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.exaMissing": "exa belum terinstal di distro ini",
  "desktop.wsl.error.exaCannotRun": "exa telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.exaNotInstalled": "Exa belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Exa selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.exa.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.exa.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.exaGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Exa",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Exa.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di exa.json",
  ...
  "dialog.server.description": "Ganti server Exa mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Exa di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Exa di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Exa di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Exa",
  "wsl.onboarding.exaReadyIn": "Exa siap di {{distro}}.",
  "wsl.onboarding.exaReady": "Exa siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Exa di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Exa dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Exa tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Exa ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Exa",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (exa.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Exa belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Exa di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Exa",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Exa di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Exa mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Exa diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Exa.",
