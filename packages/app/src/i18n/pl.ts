export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Exa",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Exa",
  "desktop.recovery.terminated": "Okno Exa zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Exa nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Exa",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.exaMissing": "Program exa nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.exaCannotRun": "Program exa jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.exaNotInstalled": "Exa nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Exa została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.exa.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.exa.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.exaGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Exa",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Exa.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku exa.json",
  ...
  "dialog.server.description": "Przełącz serwer Exa, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Exa w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Exa w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Exa w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Exa",
  "wsl.onboarding.exaReadyIn": "Exa jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.exaReady": "Exa jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Exa w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Exa będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Exa nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Exa ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Exa",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (exa.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Exa nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Exa zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Exa wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Exa",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Exa na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Exa ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Exa.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Exa",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Exa.",
