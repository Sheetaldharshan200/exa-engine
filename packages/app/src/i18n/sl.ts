export const dict = {
  ...
  "desktop.menu.documentation": "Exa Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Exa ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Exa se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Exa se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Exa ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.exaMissing": "exa ni nameščen v tej distribuciji",
  "desktop.wsl.error.exaCannotRun": "exa je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.exaNotInstalled": "Exa ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Exa je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.exa.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.exa.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.exaGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Exa",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  "provider.connect.exaZen.line2":
    "Z enim samim ključem API boste dobili dostop do modelov, kot so Claude, GPT, Gemini, GLM in več.",
  "provider.connect.exaZen.visit.prefix": "Obisk ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Exa.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v exa.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Exa se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Exa ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Exa v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Exa ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Exa v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Exa v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Exa",
  "wsl.onboarding.exaReadyIn": "Exa je pripravljen v {{distro}}.",
  "wsl.onboarding.exaReady": "Exa je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Exa v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Exa doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Exa ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Exa ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Exa",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (exa.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Exa še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Exa znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Exa",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Exa izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Exa sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Exa.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Exa",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Exa.",
