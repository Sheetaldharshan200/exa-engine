export const dict = {
  ...
  "desktop.menu.documentation": "Документация Exa",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Exa",
  "desktop.recovery.terminated": "Окно Exa неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Exa не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Exa",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.exaMissing": "exa не установлен в этом дистрибутиве",
  "desktop.wsl.error.exaCannotRun": "exa установлен, но его не удалось запустить",
  "desktop.wsl.error.exaNotInstalled": "Exa не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Exa завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.provider.exa.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.exa.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.exaGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Exa",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  "provider.connect.exaZen.line2":
    "С одним ключом API вы получите доступ к таким моделям, как Claude, GPT, Gemini, GLM и другие.",
  "provider.connect.exaZen.visit.prefix": "Посетите ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": ", чтобы получить ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Exa.",
  ...
  "dialog.plugins.empty": "Плагины настроены в exa.json",
  ...
  "dialog.server.description": "Выберите сервер Exa, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка Exa в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление Exa в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите Exa в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить Exa",
  "wsl.onboarding.exaReadyIn": "Exa в {{distro}} готов к работе.",
  "wsl.onboarding.exaReady": "Exa готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите Exa в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Exa требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Exa не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Exa.",
  ...
  "help.tabs.introduction": "Теперь работа в Exa Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Exa ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Exa",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (exa.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Exa пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Exa включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Exa внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Exa",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Exa на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Exa системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Exa.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Exa",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Exa.",
