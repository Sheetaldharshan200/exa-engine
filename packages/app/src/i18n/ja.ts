export const dict = {
  ...
  "desktop.recovery.loadFailed": "Exaを読み込めませんでした",
  "desktop.recovery.terminated": "Exaのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Exaが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Exaのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.exaMissing": "このディストリビューションにはexaがインストールされていません",
  "desktop.wsl.error.exaCannotRun": "exaはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.exaNotInstalled": "{{distro}}にはExaがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Exaのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.exa.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.exa.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.exaGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Exaが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Exaで{{provider}}モデルを使用します。",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.exaZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.exaZen.visit.prefix": " ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してExaで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Exaで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "exa.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するExaサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Exaを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のExaを確認中...",
  "wsl.onboarding.updatingOpencode": "Exaを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のExaを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のExaを更新してください。",
  "wsl.onboarding.updateOpencode": "Exaを更新",
  "wsl.onboarding.exaReadyIn": "{{distro}}内のExaの準備ができました。",
  "wsl.onboarding.exaReady": "Exaの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にExaをインストールしてください。",
  "wsl.onboarding.installOpencode": "Exaをインストール",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exaがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ExaでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Exaをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Exa Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Exaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをExaチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (exa.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ExaはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Exaには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でExaサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Exaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのExaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Exaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Exaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Exa の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Exa は最新バージョンです。",
