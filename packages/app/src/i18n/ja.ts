export const dict = {
  ...
  "desktop.wsl.error.installExa": "Exaのインストールに失敗しました",
  ...
  "wsl.onboarding.checkingExa": "Exaを確認中...",
  "wsl.onboarding.checkingExaIn": "{{distro}}内のExaを確認中...",
  "wsl.onboarding.updatingExa": "Exaを更新中...",
  "wsl.onboarding.updatingExaIn": "{{distro}}内のExaを更新中...",
  "wsl.onboarding.updateExaIn": "{{distro}}内のExaを更新してください。",
  "wsl.onboarding.updateExa": "Exaを更新",
  "wsl.onboarding.exaReadyIn": "{{distro}}内のExaの準備ができました。",
  "wsl.onboarding.exaReady": "Exaの準備ができました。",
  "wsl.onboarding.installExaIn": "{{distro}}にExaをインストールしてください。",
  "wsl.onboarding.installExa": "Exaをインストール",
