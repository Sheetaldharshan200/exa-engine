export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Exa",
  ...
  "desktop.menu.ariaLabel": "Menu Exa",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Exa",
  "desktop.recovery.terminated": "La fenêtre Exa s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Exa ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Exa",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.exaMissing": "exa n'est pas installé dans cette distribution",
  "desktop.wsl.error.exaCannotRun": "exa est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.exaNotInstalled": "Exa n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Exa est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.exa.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.exa.tagline": "Modèles optimisés et fiables",
  "dialog.provider.exaGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Exa",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.exaZen.visit.prefix": "Visitez ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Exa.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans exa.json",
  ...
  "dialog.server.description": "Changez le serveur Exa auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Exa dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Exa dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Exa dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Exa",
  "wsl.onboarding.exaReadyIn": "Exa est prêt dans {{distro}}.",
  "wsl.onboarding.exaReady": "Exa est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Exa dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Exa puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Exa n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Exa ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Exa",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (exa.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Exa ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Exa inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Exa dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Exa",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Exa sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Exa suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Exa.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Exa",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Exa.",
