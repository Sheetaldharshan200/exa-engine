export const dict = {
  ...
  "desktop.wsl.error.installExa": "Exa quraşdırılması uğursuz oldu",
  ...
  "wsl.onboarding.checkingExa": "Exa yoxlanılır...",
  "wsl.onboarding.checkingExaIn": "{{distro}}-də Exa yoxlanılır...",
  "wsl.onboarding.updatingExa": "Exa yenilənir...",
  "wsl.onboarding.updatingExaIn": "{{distro}}-də Exa yenilənir...",
  "wsl.onboarding.updateExaIn": "{{distro}}-də Exa-u yeniləyin.",
  "wsl.onboarding.updateExa": "Exa-u yeniləyin",
  "wsl.onboarding.exaReadyIn": "Exa {{distro}}-də hazırdır.",
  "wsl.onboarding.exaReady": "Exa hazırdır.",
  "wsl.onboarding.installExaIn": "Exa-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installExa": "Exa quraşdırın",
