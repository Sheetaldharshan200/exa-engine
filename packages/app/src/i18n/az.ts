export const dict = {
  ...
  "desktop.recovery.loadFailed": "Exa yüklənə bilmədi",
  "desktop.recovery.terminated": "Exa pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Exa cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Exa quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.exaMissing": "Bu distribütivdə exa quraşdırılmayıb",
  "desktop.wsl.error.exaCannotRun": "exa quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.exaNotInstalled": "Exa {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Exa yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.exa.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.exa.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.exaGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Exa tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Exa-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Exa-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Exa-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər exa.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Exa serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Exa yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Exa yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Exa yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Exa yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Exa-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Exa-u yeniləyin",
  "wsl.onboarding.exaReadyIn": "Exa {{distro}}-də hazırdır.",
  "wsl.onboarding.exaReady": "Exa hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Exa-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Exa quraşdırın",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Exa WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Exa bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Exa-u yenidən açın.",
  ...
  "help.tabs.introduction": "Exa Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Exa-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Exa komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (exa.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Exa hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Exa-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Exa serverini işlət.",
  ...
  "settings.general.row.language.description": "Exa üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Exa-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Exa-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Exa-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Exa açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Exa-un ən son versiyasından istifadə edirsiniz.",
