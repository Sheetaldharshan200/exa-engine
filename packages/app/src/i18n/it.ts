export const dict = {
  ...
  "dialog.provider.exa.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.exa.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.exaGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Exa",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.exaZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Exa.",
  ...
  "dialog.plugins.empty": "Plugin configurati in exa.json",
  ...
  "dialog.server.description": "Cambia il server Exa a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Exa in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Exa in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Exa in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Exa",
  "wsl.onboarding.exaReadyIn": "Exa è pronto in {{distro}}.",
  "wsl.onboarding.exaReady": "Exa è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Exa in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Exa possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Exa non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Exa ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Exa",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (exa.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Exa non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Exa all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Exa",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Exa sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Exa segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Exa.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Exa",
  ...
  "settings.updates.toast.latest.title": "Exa è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Exa.",
  ...
  "desktop.menu.documentation": "Documentazione di Exa",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Exa",
  "desktop.recovery.terminated": "La finestra di Exa si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Exa non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Exa non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.exaMissing": "exa non è installato in questa distribuzione",
  "desktop.wsl.error.exaCannotRun": "exa è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.exaNotInstalled": "Exa non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Exa è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
