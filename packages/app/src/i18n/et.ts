export const dict = {
  ...
  "desktop.recovery.loadFailed": "Exa laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Exa aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Exa ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Exa installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.exaMissing": "exa pole sellesse distrosse installitud",
  "desktop.wsl.error.exaCannotRun": "exa on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.exaNotInstalled": "Exa pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.exa.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.exa.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.exaGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Exa",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Exa'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Exa.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis exa.json",
  ...
  "dialog.server.description": "Lülitage, millise Exa serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Exa kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Exa kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Exa värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Exa värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Exa jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Exa",
  "wsl.onboarding.exaReadyIn": "Exa on valmis {{distro}}.",
  "wsl.onboarding.exaReady": "Exa on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Exa asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Exa saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Exa ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Exa.",
  ...
  "help.tabs.introduction": "Exa Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Exa ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Exa meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (exa.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Exa ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Exa sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage Exa server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Exa kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Exa teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Exa järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Exa on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Exa käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Exa uusimat versiooni.",
