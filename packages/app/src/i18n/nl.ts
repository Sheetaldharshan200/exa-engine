export const dict = {
  ...
  "desktop.menu.documentation": "Exa-documentatie",
  ...
  "desktop.recovery.loadFailed": "Exa kan niet worden geladen",
  "desktop.recovery.terminated": "Het Exa-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Exa reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Exa is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.exaMissing": "exa is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.exaCannotRun": "exa is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.exaNotInstalled": "Exa is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Exa-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.exa.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.exa.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.exaGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Exa",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Exa te gebruiken.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.exaZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.exaZen.visit.prefix": "Ga naar ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Exa te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Exa te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in exa.json",
  ...
  "dialog.server.description": "Wijzig met welke Exa-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Exa controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Exa controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Exa bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Exa bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Exa bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Exa bijwerken",
  "wsl.onboarding.exaReadyIn": "Exa is gereed in {{distro}}.",
  "wsl.onboarding.exaReady": "Exa is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Exa in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Exa een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Exa kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Exa opnieuw.",
  ...
  "help.tabs.introduction": "Exa Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Exa ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Exa-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (exa.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Exa ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Exa bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Exa-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Exa",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Exa eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Exa het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Exa aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Exa wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Exa is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Exa.",
