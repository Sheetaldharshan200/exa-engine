...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Exa se nije uspio učitati",
  "Prozor aplikacije Exa neočekivano je zatvoren",
  "Exa ne reagira",
  ...
  "Instalacija aplikacije Exa nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "exa nije instaliran u ovoj distribuciji",
  "exa je instaliran, ali se ne može pokrenuti",
  "Exa nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Exa je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.exa.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.exa.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.exaGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Exa",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Exa.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u exa.json",
  ...
  "dialog.server.description": "Promijenite na koji se Exa poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Exa u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Exa u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Exa u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Exa",
  "wsl.onboarding.exaReadyIn": "Exa je spreman u {{distro}}.",
  "wsl.onboarding.exaReady": "Exa je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Exa u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Exa",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Exa može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Exa nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Exa.",
  ...
  "help.tabs.introduction": "Radna površina Exa sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Exa ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Exa timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (exa.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Exa još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Exa uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Exa Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Exa poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Exa",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Exa izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Exa slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Exa tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Exa pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Exa.",
