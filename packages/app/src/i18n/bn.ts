export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.installExa": "Exa ইনস্টলেশন ব্যর্থ হয়েছে৷",
  ...
  "wsl.onboarding.checkingExa": "Exa পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingExaIn": "{{distro}} এ Exa চেক করা হচ্ছে...",
  "wsl.onboarding.updatingExa": "আপডেট করা হচ্ছে Exa...",
  "wsl.onboarding.updatingExaIn": "{{distro}}-এ Exa আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateExaIn": "{{distro}}-এ Exa আপডেট করুন।",
  "wsl.onboarding.updateExa": "Exa আপডেট করুন",
  "wsl.onboarding.exaReadyIn": "Exa {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.exaReady": "Exa প্রস্তুত।",
  "wsl.onboarding.installExaIn": "{{distro}}-এ Exa ইনস্টল করুন।",
  "wsl.onboarding.installExa": "Exa ইনস্টল করুন",
