...
export const dict = {
  ...
  "desktop.menu.documentation": "Exa-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Exa-meny",
  ...
  "desktop.recovery.loadFailed": "Exa kunne ikke lastes inn",
  "desktop.recovery.terminated": "Exa-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Exa svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Exa mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.exaMissing": "exa er ikke installert i denne distribusjonen",
  "desktop.wsl.error.exaCannotRun": "exa er installert, men kunne ikke kjøres",
  "desktop.wsl.error.exaNotInstalled": "Exa er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Exa er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.exa.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.exa.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.exaGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Exa",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.exaZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.exaZen.visit.prefix": "Besøk ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Exa.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i exa.json",
  ...
  "dialog.server.description": "Bytt hvilken Exa-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Exa ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Exa-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (exa.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Exa ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Exa inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Exa-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Exa",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Exa ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Exa skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Exa.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Exa starter",
  ...
  "settings.updates.toast.latest.title": "Exa er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Exa.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Exa i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Exa i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Exa i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Exa",
  "wsl.onboarding.exaReadyIn": "Exa er klar i {{distro}}.",
  "wsl.onboarding.exaReady": "Exa er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Exa i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Exa kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Exa kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Exa på nytt.",
  ...
  "help.tabs.introduction": "Exa Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
