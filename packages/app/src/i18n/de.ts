...
export const dict = {
  ...
  "dialog.provider.exa.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.exa.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.exaGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Exa",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Exa zu nutzen.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.exaZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Exa zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Exa zu nutzen.",
  ...
  "dialog.plugins.empty": "In exa.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Exa-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Exa wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Exa in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Exa wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Exa in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Exa in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Exa aktualisieren",
  "wsl.onboarding.exaReadyIn": "Exa ist in {{distro}} bereit.",
  "wsl.onboarding.exaReady": "Exa ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Exa in {{distro}}.",
  "wsl.onboarding.installOpencode": "Exa installieren",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Exa einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Exa konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Exa erneut.",
  ...
  "toast.update.description": "Eine neue Version von Exa ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Exa-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (exa.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Exa unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Exa mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Exa enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Exa-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Exa ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Exa auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Exa dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Exa anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Exa automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Exa ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Exa wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Exa konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Exa-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Exa reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Exa-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.exaMissing": "exa ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.exaCannotRun": "exa ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.exaNotInstalled": "Exa ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Exa-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Exa Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
