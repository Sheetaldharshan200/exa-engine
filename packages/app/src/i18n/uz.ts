export const dict = {
  ...
  "desktop.menu.documentation": "Exa hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Exa menyusi",
  ...
  "desktop.recovery.loadFailed": "Exa yuklanmadi",
  "desktop.recovery.terminated": "Exa oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Exa javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Exa oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.exaMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.exaCannotRun": "exa o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.exaNotInstalled": "Exa {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Exa yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.exa.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.exa.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.exaGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Exa tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Exa’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Exa da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Exa da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "exa.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Exa serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Exa tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Exa {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Exa yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Exa {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Exa-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Exa-ni yangilang",
  "wsl.onboarding.exaReadyIn": "Exa {{distro}} da tayyor.",
  "wsl.onboarding.exaReady": "Exa tayyor.",
  "wsl.onboarding.installOpencodeIn": "Exa-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Exa-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Exa WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Exa WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Exa-ni qayta oching.",
  ...
  "help.tabs.introduction": "Exa Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Exa ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Exa jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (exa.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Exa hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Exa bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Exa serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Exa uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Exa qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Exa tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Exa mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Exa ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Exa oxirgi versiyasini ishga tushiryapsiz.",
