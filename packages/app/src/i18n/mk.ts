export const dict = {
  ...
  "desktop.menu.documentation": "Exa Документација",
  ...
  "desktop.menu.ariaLabel": "Exa мени",
  ...
  "desktop.recovery.loadFailed": "Exa не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот Exa неочекувано заврши",
  "desktop.recovery.unresponsive": "Exa не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата Exa не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.exaMissing": "exa не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.exaCannotRun": "exa е инсталиран, но не може да се изврши",
  "desktop.wsl.error.exaNotInstalled": "Exa не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.exa.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.exa.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.exaGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од Exa",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  "provider.connect.exaZen.line2":
    "Со еден клуч API ќе добиете пристап до модели како што се Claude, GPT, Gemini, GLM и повеќе.",
  "provider.connect.exaZen.visit.prefix": "Посетете",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во Exa.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во exa.json",
  ...
  "dialog.server.description": "Променете на кој Exa сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува Exa во {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Се ажурира Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира Exa во {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте Exa во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај Exa",
  "wsl.onboarding.exaReadyIn": "Exa е подготвен во {{distro}}.",
  "wsl.onboarding.exaReady": "Exa е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте Exa во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред Exa да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "Exa не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на Exa ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот Exa",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (exa.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, Exa сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "Exa вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот Exa во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за Exa",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа Exa на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали Exa ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како Exa е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува Exa",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на Exa.",
