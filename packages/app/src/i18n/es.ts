export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Exa",
  ...
  "desktop.menu.ariaLabel": "Menú de Exa",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Exa",
  "desktop.recovery.terminated": "La ventana de Exa se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Exa no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Exa",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.exaMissing": "exa no está instalado en esta distribución",
  "desktop.wsl.error.exaCannotRun": "exa está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.exaNotInstalled": "Exa no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Exa finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.exa.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.exa.tagline": "Modelos optimizados y fiables",
  "dialog.provider.exaGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Exa",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.exaZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Exa.",
  ...
  "dialog.plugins.empty": "Plugins configurados en exa.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Exa al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Exa en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Exa en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Exa en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Exa",
  "wsl.onboarding.exaReadyIn": "Exa está listo en {{distro}}.",
  "wsl.onboarding.exaReady": "Exa está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Exa en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Exa pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Exa no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Exa ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Exa",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (exa.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Exa aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Exa dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Exa",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Exa en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Exa sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Exa.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Exa",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Exa.",
