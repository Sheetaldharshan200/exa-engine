export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Exa",
  "desktop.recovery.terminated": "توقفت نافذة Exa بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Exa لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Exa",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.exaMissing": "exa غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.exaCannotRun": "exa مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.exaNotInstalled": "Exa غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Exa، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.exa.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.exa.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.exaGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Exa",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Exa.",
  ...
  "provider.connect.exaZen.line1":
    "يمنحك Exa Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.exaZen.visit.prefix": "قم بزيارة ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Exa.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في exa.json",
  ...
  "dialog.server.description": "تبديل خادم Exa الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Exa...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Exa في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Exa...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Exa في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Exa في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Exa",
  "wsl.onboarding.exaReadyIn": "Exa جاهز في {{distro}}.",
  "wsl.onboarding.exaReady": "Exa جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Exa في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Exa من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Exa التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Exa.",
  ...
  "help.tabs.introduction": "أصبح Exa Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Exa ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Exa",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (exa.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Exa لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Exa نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Exa داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Exa",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Exa على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Exa يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Exa.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Exa",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Exa.",
