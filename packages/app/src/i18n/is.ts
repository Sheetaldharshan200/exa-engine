...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Exa",
  "Exa-glugganum var óvænt lokað",
  "Exa svarar ekki",
  ...
  "Uppsetning Exa mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "exa er ekki uppsett í þessari dreifingu",
  "exa er uppsett en ekki var hægt að keyra það",
  "Exa er ekki uppsett í {{distro}}",
  "Uppfærslu Exa lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.exa.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.exa.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.exaGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Exa",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Exa.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í exa.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Exa miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Exa í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Exa í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Exa í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Exa",
  "wsl.onboarding.exaReadyIn": "Exa er tilbúið í {{distro}}.",
  "wsl.onboarding.exaReady": "Exa er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Exa í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Exa getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Exa gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Exa aftur.",
  ...
  "help.tabs.introduction": "Exa Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Exa ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Exa teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (exa.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Exa styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Exa inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "settings.desktop.wsl.description": "Keyrðu Exa netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Exa",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Exa lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Exa fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Exa er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Exa ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Exa.",
