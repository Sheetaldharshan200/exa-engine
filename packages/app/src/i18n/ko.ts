export const dict = {
  ...
  "wsl.onboarding.checkingExa": "Exa 확인 중...",
  "wsl.onboarding.checkingExaIn": "{{distro}}에서 Exa 확인 중...",
  "wsl.onboarding.updatingExa": "Exa 업데이트 중...",
  "wsl.onboarding.updatingExaIn": "{{distro}}에서 Exa 업데이트 중...",
  "wsl.onboarding.updateExaIn": "{{distro}}에서 Exa를 업데이트하세요.",
  "wsl.onboarding.updateExa": "Exa 업데이트",
  "wsl.onboarding.exaReadyIn": "{{distro}}에서 Exa를 사용할 준비가 되었습니다.",
  "wsl.onboarding.exaReady": "Exa가 준비되었습니다.",
  "wsl.onboarding.installExaIn": "{{distro}}에 Exa를 설치하세요.",
  "wsl.onboarding.installExa": "Exa 설치",
  ...
  "desktop.wsl.error.installExa": "Exa 설치 실패",
