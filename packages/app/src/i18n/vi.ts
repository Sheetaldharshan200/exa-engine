export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Exa",
  ...
  "desktop.recovery.loadFailed": "Không tải được Exa",
  "desktop.recovery.terminated": "Cửa sổ Exa đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Exa không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Exa",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.exaMissing": "exa chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.exaCannotRun": "exa đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.exaNotInstalled": "Exa chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Exa nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.exa.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.exa.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.exaGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Exa cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Exa.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong exa.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Exa mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Exa trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Exa trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Exa trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Exa",
  "wsl.onboarding.exaReadyIn": "Exa đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.exaReady": "Exa đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Exa trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Exa có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Exa không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Exa ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Exa",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (exa.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Exa chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Exa bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Exa",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Exa trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Exa tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Exa.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Exa khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Exa.",
