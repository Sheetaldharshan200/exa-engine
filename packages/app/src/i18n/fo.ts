export const dict = {
  ...
  "desktop.menu.documentation": "Exa Skjøl",
  ...
  "desktop.menu.ariaLabel": "Exa valmynd",
  ...
  "desktop.recovery.loadFailed": "Exa miseydnaðist at heinta",
  "desktop.recovery.terminated": "Exa vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Exa svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Exa uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.exaMissing": "exa er ikki sett upp í hesi distro",
  "desktop.wsl.error.exaCannotRun": "exa er sett upp men kundi ikki koyra",
  "desktop.wsl.error.exaNotInstalled": "Exa er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.exa.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.exa.tagline": "Álítandi optimerað modell",
  "dialog.provider.exaGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Exa",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.exaZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.exaZen.visit.prefix": "Vitja ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Exa.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í exa.json",
  ...
  "dialog.server.description": "Skift hvønn Exa ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Exa í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Exa í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Exa í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Exa",
  "wsl.onboarding.exaReadyIn": "Exa er klárt í {{distro}}.",
  "wsl.onboarding.exaReady": "Exa er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Exa upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Exa kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Exa kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Exa aftur.",
  ...
  "help.tabs.introduction": "Exa Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Exa ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Exa toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (exa.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Exa stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Exa inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Exa Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Exa ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Exa",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Exa sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Exa fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Exa er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Exa byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Exa.",
