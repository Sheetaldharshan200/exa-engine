export const dict = {
  ...
  "desktop.menu.documentation": "Exa Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Exa menýusy",
  ...
  "desktop.recovery.loadFailed": "Exa ýükläp bilmedi",
  "desktop.recovery.terminated": "Exa penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Exa jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "Exa gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.exaMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.exaCannotRun": "exa guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.exaNotInstalled": "Exa {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Exa täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.exa.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.exa.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.exaGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Exa tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Exa-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.exaZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.exaZen.visit.prefix": "Sapar ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Exa-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Exa-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "exa.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Exa serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "Exa barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Exa barlanýar...",
  "wsl.onboarding.updatingOpencode": "Exa täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de Exa täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "Exa-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "Exa täzeläň",
  "wsl.onboarding.exaReadyIn": "Exa {{distro}}-de taýýar.",
  "wsl.onboarding.exaReady": "Exa taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de Exa guruň.",
  "wsl.onboarding.installOpencode": "Exa guruň",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Exa WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Exa bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Exa açyň.",
  ...
  "help.tabs.introduction": "Exa Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Exa ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Exa toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (exa.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Exa entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Exa mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Exa serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Exa üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Exa enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Exa ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Exa-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Exa işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Exa-iň iň soňky wersiýasyny işleýärsiňiz.",
