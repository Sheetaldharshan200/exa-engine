...
const desktop = [
  ...
  "Exa įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "exa šiame distributyve neįdiegtas",
  "exa įdiegtas, bet jo paleisti nepavyko",
  "Exa neįdiegtas distributyve {{distro}}",
  "Exa naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.exa.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.exa.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.exaGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Exa modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Exa.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti exa.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Exa serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Exa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Exa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Exa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Exa",
  "wsl.onboarding.exaReadyIn": "Exa yra paruoštas {{distro}}.",
  "wsl.onboarding.exaReady": "Exa yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Exa į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Exa galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Exa nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Exa ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Exa komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (exa.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Exa dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Exa apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Exa darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Exa serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Exa ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Exa atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Exa seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Exa temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Exa",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Exa versiją.",
