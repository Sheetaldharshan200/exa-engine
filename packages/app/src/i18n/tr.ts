...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Exa yüklenemedi",
  "desktop.recovery.terminated": "Exa penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Exa yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Exa kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.exaMissing": "exa bu dağıtımda kurulu değil",
  "desktop.wsl.error.exaCannotRun": "exa kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.exaNotInstalled": "Exa, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Exa güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.exa.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.exa.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.exaGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Exa tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Exa'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.exaZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Exa'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Exa'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler exa.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Exa sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Exa kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Exa kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Exa güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Exa güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Exa'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Exa'u güncelle",
  "wsl.onboarding.exaReadyIn": "{{distro}} içinde Exa hazır.",
  "wsl.onboarding.exaReady": "Exa hazır.",
  "wsl.onboarding.installOpencodeIn": "Exa'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Exa'u kur",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Exa'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Exa bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Exa'u tekrar açın.",
  ...
  "help.tabs.introduction": "Exa Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Exa'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Exa ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (exa.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Exa henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Exa ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "Exa sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Exa'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Exa'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Exa'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Exa'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Exa başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Exa'un en son sürümünü kullanıyorsunuz.",
