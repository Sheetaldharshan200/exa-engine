export const dict = {
  ...
  "desktop.wsl.error.installExa": "Instalimi i Exa dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.exaMissing": "Exa nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.exaCannotRun": "Exa është instaluar por nuk mund të ekzekutohet",
  ...
  "wsl.onboarding.checkingExa": "Po kontrollon Exa...",
  "wsl.onboarding.checkingExaIn": "Po kontrollon Exa në {{distro}}...",
  "wsl.onboarding.updatingExa": "Exa po përditësohet...",
  "wsl.onboarding.updatingExaIn": "Po përditëson Exa në {{distro}}...",
  "wsl.onboarding.updateExaIn": "Përditëso Exa në {{distro}}.",
  "wsl.onboarding.updateExa": "Përditëso Exa",
  "wsl.onboarding.exaReadyIn": "Exa është gati në {{distro}}.",
  "wsl.onboarding.exaReady": "Exa është gati.",
  "wsl.onboarding.installExaIn": "Instaloni Exa në {{distro}}.",
  "wsl.onboarding.installExa": "Instaloni Exa",
