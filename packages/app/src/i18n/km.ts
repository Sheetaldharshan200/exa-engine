export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ Exa",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ Exa",
  ...
  "desktop.recovery.loadFailed": "Exa បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច Exa ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "Exa មិនឆ្លើយតបទេ។",
  ...
  "desktop.wsl.error.installOpencode": "ការដំឡើង Exa បានបរាជ័យ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ត្រូវបានបន្ថែមរួចហើយ",
  "desktop.wsl.error.exaMissing": "exa មិនត្រូវបានដំឡើងនៅក្នុង distro នេះទេ។",
  "desktop.wsl.error.exaCannotRun": "exa ត្រូវបានដំឡើង ប៉ុន្តែមិនអាចដំណើរការបានទេ។",
  "desktop.wsl.error.exaNotInstalled": "Exa មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  "desktop.wsl.error.updateVersion":
    "ការធ្វើបច្ចុប្បន្នភាព Exa បានបញ្ចប់ ប៉ុន្តែ {{distro}} នៅតែរាយការណ៍ {{installed}}; {{expected}} រំពឹងទុក",
  ...
  "dialog.provider.exa.note": "ម៉ូដែលដែលបានជ្រើសរើសរួមមាន Claude, GPT, Gemini និងច្រើនទៀត",
  "dialog.provider.exa.tagline": "ម៉ូដែលដែលបានកែលម្អដែលអាចទុកចិត្តបាន។",
  "dialog.provider.exaGo.tagline": "ការជាវតម្លៃទាបសម្រាប់អ្នករាល់គ្នា",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ Exa",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង Exa។",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ដើម្បីប្រមូលលេខកូដអនុញ្ញាតរបស់អ្នកដើម្បីភ្ជាប់គណនីរបស់អ្នក និងប្រើម៉ូដែល {{provider}} នៅក្នុង Exa ។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង Exa។",
  ...
  "dialog.plugins.empty": "កម្មវិធីជំនួយដែលបានកំណត់រចនាសម្ព័ន្ធនៅក្នុង exa.json",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ Exa ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "wsl.onboarding.checkingOpencode": "កំពុងពិនិត្យមើលកូដ Exa...",
  "wsl.onboarding.checkingOpencodeIn": "កំពុងពិនិត្យកូដ Exa ក្នុង {{distro}}...",
  "wsl.onboarding.updatingOpencode": "កំពុងអាប់ដេត Exa...",
  "wsl.onboarding.updatingOpencodeIn": "កំពុងអាប់ដេត Exa ក្នុង {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ធ្វើបច្ចុប្បន្នភាព Exa ក្នុង {{distro}} ។",
  "wsl.onboarding.updateOpencode": "ធ្វើបច្ចុប្បន្នភាព Exa",
  "wsl.onboarding.exaReadyIn": "Exa គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.exaReady": "Exa គឺរួចរាល់។",
  "wsl.onboarding.installOpencodeIn": "ដំឡើង Exa ក្នុង {{distro}} ។",
  "wsl.onboarding.installOpencode": "ដំឡើង Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល Exa អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "Exa មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក Exa ឡើងវិញ។",
  ...
  "help.tabs.introduction": "Exa Desktop ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "toast.update.description": "កំណែថ្មីនៃ Exa ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម Exa",
  ...
  "error.chain.checkConfig": "ពិនិត្យការកំណត់រចនាសម្ព័ន្ធរបស់អ្នក (exa.json) អ្នកផ្តល់សេវា/ឈ្មោះម៉ូដែល",
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ Exa មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "Exa រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ Exa នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ Exa",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល Exa មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ Exa ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល Exa មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល Exa ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ Exa ។",
