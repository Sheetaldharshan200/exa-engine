export const dict = {
  ...
  "desktop.menu.documentation": "Exa دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Exa مینو",
  ...
  "desktop.recovery.loadFailed": "Exa لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Exa ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Exa جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Exa کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.exaMissing": "اس ڈسٹری بیوشن میں exa انسٹال نہیں ہے",
  "desktop.wsl.error.exaCannotRun": "exa انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.exaNotInstalled": "{{distro}} میں Exa انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Exa کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.exa.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.exa.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.exaGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Exa کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Exa میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.exaZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.exaZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Exa میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Exa میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "exa.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Exa سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Exa چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Exa چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Exa کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Exa کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Exa کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Exa کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.exaReadyIn": "Exa {{distro}} میں تیار ہے۔",
  "wsl.onboarding.exaReady": "Exa تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Exa انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Exa انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Exa WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Exa اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Exa کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Exa Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Exa ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Exa ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (exa.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Exa ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Exa میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Exa سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Exa کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Exa کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Exa سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Exa کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Exa لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Exa کا تازہ ترین ورژن چلا رہے ہیں۔",
