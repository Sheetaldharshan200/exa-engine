export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Exa",
  ...
  "desktop.menu.ariaLabel": "Menu do Exa",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Exa",
  "desktop.recovery.terminated": "A janela do Exa foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Exa não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Exa",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.exaMissing": "O exa não está instalado nesta distribuição",
  "desktop.wsl.error.exaCannotRun": "O exa está instalado, mas não pôde ser executado",
  "desktop.wsl.error.exaNotInstalled": "O Exa não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Exa foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.exa.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.exa.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.exaGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Exa",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.exaZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.exaZen.visit.prefix": "Visite ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Exa.",
  ...
  "dialog.plugins.empty": "Plugins configurados em exa.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Exa este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Exa em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Exa em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Exa em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Exa",
  "wsl.onboarding.exaReadyIn": "O Exa está pronto em {{distro}}.",
  "wsl.onboarding.exaReady": "O Exa está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Exa em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Exa possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Exa não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Exa novamente.",
  ...
  "help.tabs.introduction": "Agora, o Exa Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Exa ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Exa",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (exa.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Exa ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Exa dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Exa",
  ...
  "settings.general.row.appearance.description": "Personalize como o Exa aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Exa segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Exa é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Exa iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Exa.",
