export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Exa",
  ...
  "desktop.recovery.loadFailed": "Exa gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Exa ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Exa tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Exa gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.exaMissing": "exa tidak dipasang dalam distro ini",
  "desktop.wsl.error.exaCannotRun": "exa dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.exaNotInstalled": "Exa tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Exa selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.exa.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.exa.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.exaGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Exa",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.exaZen.visit.prefix": "Layari",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Exa.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam exa.json",
  ...
  "dialog.server.description": "Tukar pelayan Exa yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Exa dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Exa dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Exa dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Exa",
  "wsl.onboarding.exaReadyIn": "Exa sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.exaReady": "Exa sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Exa dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Exa boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Exa tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Exa ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Exa",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (exa.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Exa belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Exa dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Exa",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Exa pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Exa mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Exa.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Exa dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Exa.",
