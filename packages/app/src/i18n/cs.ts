export const dict = {
  ...
  "desktop.menu.documentation": "Exa Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Exa",
  ...
  "desktop.recovery.loadFailed": "Exa se nepodařilo načíst",
  "desktop.recovery.terminated": "Exa okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Exa nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Exa instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.exaMissing": "exa není v této distribuci nainstalováno",
  "desktop.wsl.error.exaCannotRun": "exa je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.exaNotInstalled": "Exa není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.exa.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.exa.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.exaGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Exa.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  "provider.connect.exaZen.line2":
    "Pomocí jediného tlačítka API získáte přístup k modelům jako Claude, GPT, Gemini, GLM a dalším.",
  "provider.connect.exaZen.visit.prefix": "Návštěva ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Exa.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v exa.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Exa serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Exa v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Exa v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Exa v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Exa",
  "wsl.onboarding.exaReadyIn": "Exa je připraveno v {{distro}}.",
  "wsl.onboarding.exaReady": "Exa je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Exa do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Exa může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Exa nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Exa.",
  ...
  "help.tabs.introduction": "Exa Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Exa ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Exa",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (exa.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Exa zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Exa uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Exa",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Exa na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Exa následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Exa.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Exa",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Exa.",
