export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Exa",
  ...
  "desktop.menu.ariaLabel": "Meniu Exa",
  ...
  "desktop.recovery.loadFailed": "Exa nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Exa s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Exa nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Exa a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.exaMissing": "exa nu este instalat în această distribuție",
  "desktop.wsl.error.exaCannotRun": "exa este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.exaNotInstalled": "Exa nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Exa s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.exa.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.exa.tagline": "Modele optimizate, fiabile",
  "dialog.provider.exaGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Exa",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Exa.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în exa.json",
  ...
  "dialog.server.description": "Schimbă serverul Exa la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Exa în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Exa în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Exa în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Exa",
  "wsl.onboarding.exaReadyIn": "Exa este gata în {{distro}}.",
  "wsl.onboarding.exaReady": "Exa este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Exa în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Exa să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Exa nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Exa ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Exa",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (exa.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Exa nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Exa în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Exa",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Exa pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Exa urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Exa.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Exa",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Exa.",
