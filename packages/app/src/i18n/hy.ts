export const dict = {
  ...
  "desktop.menu.documentation": "Exa Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Exa մենյու",
  ...
  "desktop.recovery.loadFailed": "Exa չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Exa պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Exa-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Exa տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.exaMissing": "exa-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.exaCannotRun": "exa-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.exaNotInstalled": "Exa տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.exa.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.exa.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.exaGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Exa",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Exa-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Exa-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Exa-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են exa.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Exa սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Exa-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Exa-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Exa-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Exa",
  "wsl.onboarding.exaReadyIn": "Exa պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.exaReady": "Exa պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Exa-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Exa-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Exa-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Exa։",
  ...
  "help.tabs.introduction": "Exa Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Exa-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Exa թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (exa.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Exa-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Exa ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Exa սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Exa",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Exa տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Exa-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Exa-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Exa-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Exa-ի վերջին տարբերակը։",
