export const dict = {
  ...
  "desktop.menu.documentation": "Exa Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Exa.",
  ...
  "desktop.recovery.loadFailed": "Exa no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Exa s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Exa no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Exa ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.exaMissing": "exa no està instal·lat en aquesta distribució",
  "desktop.wsl.error.exaCannotRun": "exa està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.exaNotInstalled": "Exa no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Exa actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.exa.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.exa.tagline": "Models optimitzats fiables",
  "dialog.provider.exaGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Exa",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Exa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Exa.",
  ...
  "dialog.plugins.empty": "Connectors configurats a exa.json",
  ...
  "dialog.server.description": "Canvia a quin Exa servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Exa...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Exa a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Exa...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Exa a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Exa a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Exa",
  "wsl.onboarding.exaReadyIn": "Exa està llest a {{distro}}.",
  "wsl.onboarding.exaReady": "Exa està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Exa a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Exa pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Exa no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Exa.",
  ...
  "help.tabs.introduction": "Exa L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Exa ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Exa.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (exa.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Exa encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exa inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Exa Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Exa dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Exa",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Exa al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Exa segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Exa.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Exa.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Exa.",
