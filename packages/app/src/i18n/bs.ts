export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Exa",
  ...
  "desktop.menu.ariaLabel": "Exa meni",
  ...
  "desktop.recovery.loadFailed": "Exa se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Exa-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Exa ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Exa-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.exaMissing": "exa nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.exaCannotRun": "exa je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.exaNotInstalled": "Exa nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Exa-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.exa.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.exa.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.exaGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Exa",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Exa-u.",
  ...
  "provider.connect.exaZen.line1":
    "Exa Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.exaZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.exaZen.visit.prefix": "Posjeti ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Exa-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Exa-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u exa.json",
  ...
  "dialog.server.description": "Promijeni na koji se Exa server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Exa u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Exa u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Exa u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Exa",
  "wsl.onboarding.exaReadyIn": "Exa je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.exaReady": "Exa je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Exa u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Exa mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Exa nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Exa-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Exa timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (exa.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Exa još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Exa uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Exa server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Exa-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Exa izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Exa prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Exa-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Exa pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Exa-a.",
