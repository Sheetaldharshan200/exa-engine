...
export const dict = {
  ...
  "dialog.provider.exa.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.exa.tagline": "Reliable optimized models",
  "dialog.provider.exaGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Exa",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Exa.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.exaZen.line1":
    "Exa Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.exaZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.exaZen.visit.prefix": "Visit ",
  "provider.connect.exaZen.visit.link": "opencode.ai/zen",
  "provider.connect.exaZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Exa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Exa.",
  ...
  "dialog.plugins.empty": "Plugins configured in exa.json",
  ...
  "dialog.server.description": "Switch which Exa server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Exa...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Exa in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Exa...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Exa in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Exa in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Exa",
  "wsl.onboarding.exaReadyIn": "Exa is ready in {{distro}}.",
  "wsl.onboarding.exaReady": "Exa is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Exa in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Exa",
  ...
  "wsl.onboarding.distroStatus.exaMissing": "Exa not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Exa can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Exa could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Exa.",
  ...
  "help.tabs.introduction": "Exa Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Exa ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Exa team",
  ...
  "error.chain.checkConfig": "Check your config (exa.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Exa does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Exa includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Exa server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Exa",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Exa looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Exa follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Exa is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Exa launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Exa.",
