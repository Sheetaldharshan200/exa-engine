...
import defaultSoundPath from "@exa/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@exa/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@exa/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@exa/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@exa/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@exa/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "exa"
const DEFAULT_PACK_ID = "exa.default"
