...
import { registerExaSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@exa/sdk/v2"
import { Locale } from "../../util/locale"
import { errorMessage } from "../../util/error"
import { formatDuration } from "../../util/format"
import { createDataWaveColors, createDataWaveFrames } from "../../ui/spinner"
...
import { EXA_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useExaKeymap } from "../../keymap"
...
export function Prompt(props: PromptProps) {
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.EXA_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
  ...
  const spinnerDef = createMemo(() => {
    ...
    // A bar chart filling and draining, not a scanner sweeping back and forth:
    // the wait belongs to a query, so it should look like one.
    return {
      frames: createDataWaveFrames(),
      color: createDataWaveColors(color),
    }
  })
