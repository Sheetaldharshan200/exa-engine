...
import { useBindings, useExaModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useExaModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.EXA_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
