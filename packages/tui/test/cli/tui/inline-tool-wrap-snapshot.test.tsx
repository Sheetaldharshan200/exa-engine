...
const tools: readonly ToolFixture[] = [
  ...
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/exa (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/exa/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/exa/src/index.ts [offset=1, limit=100]",
