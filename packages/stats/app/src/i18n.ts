...
const en = {
  "app.title": "AI Model Usage Rankings | Exa Data",
  "app.description":
    "Explore Exa Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Exa Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Exa on GitHub",
  "header.github": "GitHub",
  "header.tryExa": "Try Exa",
  ...
  "home.topModelsDescription": "Usage of models across Exa Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Exa Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Exa Data",
  "lab.description":
    "Compare {{lab}} models used in Exa Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Exa usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Exa",
  ...
  "lab.shareOfUsage": "{{share}} of recent Exa usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Exa Data",
  "model.description":
    "View {{model}} Exa Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Exa Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Exa Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Exa Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Exa Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Exa Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Exa Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Exa Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Exa Go token volume.",
