export const dict = {
  "app.title": "Rankingi użycia modeli AI | Exa Data",
  "app.description":
    "Przeglądaj użycie Exa Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Exa Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Exa na GitHub",
  "header.github": "GitHub",
  "header.tryExa": "Wypróbuj Exa",
  ...
  "footer.homeAria": "Strona główna Exa",
  ...
  "home.topModelsDescription": "Użycie modeli w Exa Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Exa Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Exa Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Exa Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Exa.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Exa",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Exa",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Exa z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Exa Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Exa Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Exa Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Exa Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Exa Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Exa Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Exa Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Exa Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Exa Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Exa Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Exa Go.",
  ...
  "model.geoDescription": "Tokeny modelu Exa Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Exa Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Exa Go.",
