...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips exa-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-exa-directory"]).toBeUndefined()
      expect(forwarded["x-exa-workspace"]).toBeUndefined()
