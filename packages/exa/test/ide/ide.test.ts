...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders EXA_CALLER", () => {
    process.env["EXA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode EXA_CALLER", () => {
    process.env["EXA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown EXA_CALLER", () => {
    process.env["EXA_CALLER"] = "unknown"
