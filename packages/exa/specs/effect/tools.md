...
Practical reference for the current tool-migration state in `packages/exa`.
...
Tool tests should use the existing Effect helpers in `packages/exa/test/lib/effect.ts`:
