...
import { normalizePromptContent } from "@exa/tui/editor"
...
import { EXA_BASE_MODE, useBindings } from "@exa/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Exa" } satisfies SlashOption,
    ]
