...
import { ProjectDirectoryTable, ProjectTable } from "@exa/core/project/sql"
import { ProjectDirectories } from "@exa/core/project/directories"
...
import { which } from "@exa/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@exa/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.EXA_FAKE_VCS)
