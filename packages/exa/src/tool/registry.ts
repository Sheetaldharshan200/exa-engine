...
import { ExasolDatabasesTool, ExasolSchemasTool, ExasolTablesTool, ExasolDescribeTool, ExasolQueryTool } from "./exasol"
...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@exa/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.exa || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@exa/ToolRegistry") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const exasolDatabases = yield* ExasolDatabasesTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          plan: Tool.init(plan),
          exasol_databases: Tool.init(exasolDatabases),
