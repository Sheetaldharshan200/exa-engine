...
import { LegacyEvent } from "@exa/schema/legacy-event"
...
export class Service extends Context.Service<Service, Interface>()("@exa/Command") {}
  ...
  Effect.gen(function* () {
    ...
    const init = Effect.fn("Command.state")(function* (ctx: InstanceContext) {
      ...
      commands[Default.INIT] = {
        name: Default.INIT,
        description: "profile the connected database into AGENTS.md",
        source: "command",
        get template() {
