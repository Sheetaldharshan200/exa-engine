...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@exa/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@exa/ACPDirectory") {}
