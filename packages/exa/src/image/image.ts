...
export class Service extends Context.Service<Service, Interface>()("@exa/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __EXA_PHOTON_WASM_PATH?: string }).__EXA_PHOTON_WASM_PATH =
