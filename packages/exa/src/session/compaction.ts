...
import { buildPrompt } from "@exa/core/session/compaction"
import { SessionCompactionEvent } from "@exa/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@exa/SessionCompaction") {}
