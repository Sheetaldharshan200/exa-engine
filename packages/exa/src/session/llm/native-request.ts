import type { JsonSchema, LLMRequest, ProviderMetadata } from "@exa/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@exa/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @exa/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
