...
import { locationServiceMapLayer } from "@exa/core/location-services"
...
import { PartTable, SessionTable } from "@exa/core/session/sql"
...
import { NonNegativeInt, optional } from "@exa/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".exa", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@exa/Session") {}
