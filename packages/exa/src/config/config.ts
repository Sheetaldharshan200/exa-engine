          ...
          const dep = yield* npmSvc
            .install(dir, {
              add: [
                {
                  name: "@exa/plugin",
                  // The @exa scope on npm is not ours; the package publishes
                  // as exa-engine-plugin and installs here under its internal
                  // name via an npm alias, so plugin files import
                  // "@exa/plugin" as documented.
