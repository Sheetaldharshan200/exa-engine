...
import { EventSequenceTable, EventTable } from "@exa/core/event/sql"
...
import { WorkspaceEvent } from "@exa/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@exa/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        EXA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        EXA_WORKSPACE_ID: config.id,
        EXA_EXPERIMENTAL_WORKSPACES: "true",
