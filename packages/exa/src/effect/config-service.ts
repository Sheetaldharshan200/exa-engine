 ...
 *   "@exa/ServerAuthConfig",
 *   {
 *     password: Config.string("EXA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("EXA_SERVER_USERNAME").pipe(Config.withDefault("exa")),
 *   },
 * ) {}
 *
