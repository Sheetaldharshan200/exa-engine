...
import { makeApi } from "@exa/protocol/api"
import { LocationMiddleware } from "@exa/server/location"
import { SessionLocationMiddleware } from "@exa/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("exa-root")
...
export const InstanceHttpApi = HttpApi.make("exa-instance")
...
export const ExaHttpApi = HttpApi.make("exa")
