...
>()("@exa/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@exa/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.EXA_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.EXA_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-exa-directory"] || process.cwd()
}
