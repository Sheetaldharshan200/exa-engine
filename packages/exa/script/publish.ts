...
const image = "ghcr.io/anomalyco/exa"
...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "url='https://github.com/anomalyco/exa'",
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    "provides=('exa')",
    "conflicts=('exa')",
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/anomalyco/exa/releases/download/v\${pkgver}\${_subver}/exa-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/anomalyco/exa/releases/download/v\${pkgver}\${_subver}/exa-linux-x64.tar.gz")`,
  ...
  const homebrewFormula = [
    ...
    `  homepage "https://github.com/anomalyco/exa"`,
    ...
    `      url "https://github.com/anomalyco/exa/releases/download/v${Script.version}/exa-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    '        bin.install "exa"',
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/anomalyco/exa/releases/download/v${Script.version}/exa-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "exa"',
    ...
    `      url "https://github.com/anomalyco/exa/releases/download/v${Script.version}/exa-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "exa"',
    "      end",
    ...
    `      url "https://github.com/anomalyco/exa/releases/download/v${Script.version}/exa-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "exa"',
    "      end",
