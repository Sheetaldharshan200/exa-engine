import { Exa } from "@exa/client/effect"
...
export const create = Effect.fn("Exa.create")(function* () {
  ...
  const client = yield* Exa.make({ baseUrl: "http://exa.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@exa/sdk-next/Exa") {}
