...
export const TypeId: TypeId = "~@exa/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@exa/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@exa/effect-sqlite-node/NodeSqliteClient")
