...
- Effect plugins import `@exa/plugin/v2/effect`, not `@exa/core`.
- Public domain values use generated `@exa/sdk` types.
...
- Define `PluginHost` domain capabilities in `@exa/plugin/v2/effect`.
