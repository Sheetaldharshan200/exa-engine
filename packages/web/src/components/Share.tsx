...
import type { MessageV2 } from "exa/session/message-v2"
import type { Message } from "exa/session/message"
import type { Session } from "exa/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.exa_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.exa_name}>
