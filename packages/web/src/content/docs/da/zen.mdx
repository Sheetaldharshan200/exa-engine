---
title: Zen
description: Udvalgt liste over modeller leveret af Exa.
---
...
Exa Zen er en liste over testede og verificerede modeller leveret af Exa-teamet.

Zen fungerer som enhver anden udbyder i Exa. Du logger ind på Exa Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Exa.
:::
...
Exa Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Exa Zen fungerer som enhver anden udbyder i Exa.

1. Du logger ind på **<a href={console}>Exa Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Exa Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Exa-konfiguration
bruger formatet `exa/<model-id>`. For eksempel ville du for GPT 5.5
bruge `exa/gpt-5.5` i din konfiguration.
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. Exa bruger disse modeller til at generere sessionstitler.
...
- DeepSeek V4 Flash Free er tilgængelig på Exa i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Exa i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Hy3 Free er tilgængelig på Exa i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Laguna S 2.1 Free er tilgængelig på Exa i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Exa i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgængelig på Exa i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Exa i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Exa også.
