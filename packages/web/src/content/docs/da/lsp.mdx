---
title: LSP-servere
description: Exa integreres med dine LSP-servere.
---

Exa kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Exa leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `EXA_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og exa åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din exa-konfiguration.
