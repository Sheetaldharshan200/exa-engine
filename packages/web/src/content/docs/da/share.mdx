---
title: Deling
description: Del dine Exa-samtaler.
---

Exas delingsfunksjon lar deg lage offentlige lenker til dine Exa-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Exa støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Exa manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `exa.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av exa i organisasjonen din.
