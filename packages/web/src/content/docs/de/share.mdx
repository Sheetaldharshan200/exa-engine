---
title: Teilen
description: Teile Exa-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Exa-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Exa Folgendes:
...
Exa hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Exa den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`exa.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du exa in deiner Organisation einsetzt.
