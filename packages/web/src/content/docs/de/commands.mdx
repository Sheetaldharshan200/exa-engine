...
Erstellen Sie `.exa/commands/test.md`:
...
Sie können benutzerdefinierte Befehle über die Exa-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Exa [config](/docs/config):
...
Exa enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
