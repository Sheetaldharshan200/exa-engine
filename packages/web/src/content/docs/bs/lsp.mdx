---
title: LSP serveri
description: Exa se integriše sa vašim LSP serverima.
---

Exa se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Exa dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `EXA_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i exa otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj exa konfiguraciji.
