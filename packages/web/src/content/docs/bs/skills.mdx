...
Agent skills omogucavaju Exa da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Exa pretrazuje ove lokacije:

- Konfiguracija projekta: `.exa/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/exa/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Exa ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.exa/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/exa/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.exa/skills/git-release/SKILL.md` ovako:
...
Exa navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `exa.json`:
