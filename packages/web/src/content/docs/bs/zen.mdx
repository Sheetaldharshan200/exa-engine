---
title: Zen
description: Kurirana lista modela koje nudi Exa.
---
...
Exa Zen je lista testiranih i provjerenih modela koje pruža Exa tim.

Zen radi kao i svaki drugi provajder u Exa. Prijavite se na Exa Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili Exa.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Exa.
:::
...
Exa Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Exa Zen radi kao i svaki drugi provajder u Exa.

1. Prijavite se na **<a href={console}>Exa Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite Exa Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj Exa konfiguraciji koristi format
`exa/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `exa/gpt-5.5`.
...
U historiji korištenja možete primijetiti [jeftinije modele](/docs/config/#models), kao što su Haiku, Nano ili Flash. Exa koristi ove modele za generisanje naslova sesija.
...
- DeepSeek V4 Flash Free je dostupan na Exa ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na Exa ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Hy3 Free je dostupan na Exa ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Laguna S 2.1 Free je dostupan na Exa ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na Exa ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3.5 Lightning Free je dostupan na Exa ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na Exa ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u Exa.
