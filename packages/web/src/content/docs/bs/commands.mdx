...
Možete dodati prilagođene komande kroz Exa konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Exa [config](/docs/config):
...
- Globalno: `~/.config/exa/commands/`
- Po projektu: `.exa/commands/`
...
Exa uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
