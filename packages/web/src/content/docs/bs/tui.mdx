---
title: TUI
description: Korištenje korisničkog interfejsa Exa terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Exa pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Exa pokreće TUI za trenutni direktorij.
...
Kada koristite Exa TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Exa. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Exa. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `exa.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Exa čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `exa.default`.
