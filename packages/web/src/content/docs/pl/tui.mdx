---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala exa.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

exa zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie exa uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI exa, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do exa. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `exa.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Exa czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `exa.default`.
