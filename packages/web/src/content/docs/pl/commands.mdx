...
Możesz zdefiniować polecenia w `exa.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji exa:
...
- Globalnie: `~/.config/exa/commands/`
- Na projekt: `.exa/commands/`
...
exa zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
