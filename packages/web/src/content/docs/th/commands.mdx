...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Exa:
...
- ระดับผู้ใช้ (Global): `~/.config/exa/commands/`
- ระดับโปรเจ็กต์: `.exa/commands/`
...
Exa มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
