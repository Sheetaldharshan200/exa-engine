...
Puoi aggiungere comandi personalizzati tramite la config di Exa o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Exa:
...
- Globale: `~/.config/exa/commands/`
- Per progetto: `.exa/commands/`
...
exa include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
