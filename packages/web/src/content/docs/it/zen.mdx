---
title: Zen
description: Lista curata di modelli fornita da Exa.
---
...
Exa Zen è un elenco di modelli testati e verificati forniti dal team di Exa.

Zen funziona come qualsiasi altro provider in Exa. Accedi a Exa Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Exa.
:::
...
Exa Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Exa Zen funziona come qualsiasi altro provider in Exa.

1. Accedi a **<a href={console}>Exa Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Exa Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Exa
usa il formato `exa/<model-id>`. Per esempio, per GPT 5.5, useresti
`exa/gpt-5.5` nella tua config.
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Exa usa questi modelli per generare i titoli delle sessioni.
...
- DeepSeek V4 Flash Free è disponibile su Exa per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Exa per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Hy3 Free è disponibile su Exa per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Laguna S 2.1 Free è disponibile su Exa per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Exa per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3.5 Lightning Free è disponibile su Exa per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Exa per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Exa.
