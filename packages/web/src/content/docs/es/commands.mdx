...
Puede agregar comandos personalizados a través de la configuración Exa o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Exa [config](/docs/config):
...
exa incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
