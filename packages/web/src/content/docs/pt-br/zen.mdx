---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Exa.
---
...
O Exa Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Exa.

O Zen funciona como qualquer outro provedor no Exa. Você faz login no Exa Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Exa.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Exa.
:::
...
O Exa Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Exa Zen funciona como qualquer outro provedor no Exa.

1. Você faz login no **<a href={console}>Exa Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Exa Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Exa usa o formato `exa/<model-id>`. Por exemplo, para GPT 5.5, você usaria `exa/gpt-5.5` na sua configuração.
...
Você pode notar [modelos de baixo custo](/docs/config/#models), como Haiku, Nano ou Flash, no seu histórico de uso. O Exa usa esses modelos para gerar títulos de sessões.
...
- DeepSeek V4 Flash Free está disponível no Exa por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no Exa por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Hy3 Free está disponível no Exa por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Laguna S 2.1 Free está disponível no Exa por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no Exa por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3.5 Lightning Free está disponível no Exa por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Exa por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Exa também.
