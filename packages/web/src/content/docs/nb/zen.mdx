---
title: Zen
description: Utvalgt liste over modeller levert av Exa.
---
...
Exa Zen er en liste over testede og verifiserte modeller levert av Exa-teamet.

Zen fungerer som enhver annen leverandør i Exa. Du logger inn på Exa Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Exa.
:::
...
Exa Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Exa Zen fungerer som enhver annen leverandør i Exa.

1. Du logger inn på **<a href={console}>Exa Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Exa Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Exa-konfigurasjonen din
bruker formatet `exa/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `exa/gpt-5.5` i konfigurasjonen din.
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. Exa bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på Exa i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Exa i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Hy3 Free er tilgjengelig på Exa i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Laguna S 2.1 Free er tilgjengelig på Exa i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Exa i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgjengelig på Exa i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Exa i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Exa også.
