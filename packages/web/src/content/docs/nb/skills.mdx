...
Agentferdigheter lar Exa oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
exa søker etter disse stedene:

- Prosjektkonfigurasjon: `.exa/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/exa/skills/<name>/SKILL.md`
...
For prosjektlokale stier går exa opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.exa/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/exa/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.exa/skills/git-release/SKILL.md` slik:
...
exa viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `exa.json`:
...
**For innebygde agenter** (i `exa.json`):
