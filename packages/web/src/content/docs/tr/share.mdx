---
title: Paylasim
description: exa konusmalarini genel baglantilarla paylasin.
---

exa'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda exa:
...
exa, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak exa manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `exa.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda exa kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
