---
title: Zen
description: exa tarafından sağlanan seçilmiş modeller listesi.
---
...
Exa Zen, Exa ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Exa'daki diğer sağlayıcılar gibi çalışır. Exa Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Exa kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Exa ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Exa Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Exa Zen, Exa'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Exa Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Exa Zen'i seçin ve API anahtarınızı yapıştırın.
...
Exa yapılandırmanızdaki [model id](/docs/config/#models) `exa/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `exa/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. Exa, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Exa'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Exa'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Hy3 Free, sınırlı bir süre için Exa'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Laguna S 2.1 Free, sınırlı bir süre için Exa'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Exa'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3.5 Lightning Free, sınırlı bir süre için Exa'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Exa'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Exa Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Exa ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
