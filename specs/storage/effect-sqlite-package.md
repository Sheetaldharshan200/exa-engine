...
- Opencode-specific path/channel selection stays in `packages/exa`.
...
1. Add `@exa/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
