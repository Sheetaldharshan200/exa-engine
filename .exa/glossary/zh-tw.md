...
- PR #13942: https://github.com/Sheetaldharshan200/exa-engine/pull/13942

## Do Not Translate (Locale Additions)

- `Exa` (preserve casing in prose; keep `exa` only when it is part of commands, package names, paths, or code)
- `Exa Zen`
- `Exa CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `exa` in prose when referring to the product name; use `Exa`
