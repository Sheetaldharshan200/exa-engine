...
- PR #10018: https://github.com/Sheetaldharshan200/exa-engine/pull/10018
- PR #12935: https://github.com/Sheetaldharshan200/exa-engine/pull/12935

## Do Not Translate (Locale Additions)

- `Exa` (preserve casing in prose; keep `exa` only in commands, package names, paths, or code)
- `Exa CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
