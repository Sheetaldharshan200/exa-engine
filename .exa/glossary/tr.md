...
- PR #15835: https://github.com/Sheetaldharshan200/exa-engine/pull/15835

## Do Not Translate (Locale Additions)

- `Exa` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `exa` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Exa` in prose, `exa` only for exact technical identifiers
...
- Avoid changing `exa` to `Exa` inside commands, URLs, package names, or code literals
