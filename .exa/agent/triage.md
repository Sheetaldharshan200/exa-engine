...
Desktop application and browser-based app issues, including `exa web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core exa server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Exa Zen, Exa Go, and billing issues.
